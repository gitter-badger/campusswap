<html>
<head><?php //TODO: fix up disclaimer ?>
...
<center><H2> Campus Swap  Web Site Agreement/ Terms of Use </H2></center>
...
<p>
	<ul type="none">
		...
		<li>Abuse of Campus Swap will lead to an account/ ip ban</li>
		<li>Campus Swap is NOT responsible for any interaction that may result from contact
			through the Campus Swap Application. MEET OR INTERACT WITH OTHER SWAP USERS AT YOUR OWN RISK</li>
		<li>Always use good judgement and caution when contacting other users on Campus Swap</li>
	</ul>
	
</p>
<blockquote>
The Campus Swap Web Site (the "Site") is an online information
service provided by Campus Swap   ("Campus Swap "),
...
MAY NOT ACCESS OR USE THE SITE. Campus Swap MAY MODIFY THIS
...
trademarks are Campus Swap, its affiliates or other third party
...
Campus Swap a non-exclusive, royalty-free, worldwide, perpetual
...
boards, forums and newsgroups) or by e-mail to Campus Swap by all
means and in any media now known or hereafter developed. You also
grant to Campus Swap the right to use your name in connection with
...
Campus Swap for any alleged or actual infringement or
misappropriation of any proprietary right in your communications to
Campus Swap.
</blockquote><p>

<!--Thank You!-->                                                                                        <img src="http://www.easyriver.com/irs/example_traffic_module.php3?level=090304_Campus Swap" alt="TrafficServer 1.01 " width="1" height="1">
...
Campus Swap. Other product and company names
...
clearly identified as being supplied by Campus Swap,
Campus Swapdoes not operate, control or endorse any information, products or
...
Campus Swap  a. You also understand that
Campus Swap cannot and
...
SITE AND THE INTERNET. Campus Swap PROVIDES THE SITE AND
...
GENERALLY, AND Campus Swap SHALL NOT BE LIABLE FOR ANY COST
...
Campus Swap DOES NOT WARRANT THAT THE SERVICE WILL BE
...
Campus Swap HAS NO CONTROL OVER AND ACCEPTS NO
RESPONSIBILITY WHATSOEVER FOR SUCH MATERIALS.
<p>

<center>LIMITATION OF LIABILITY</center><br>
IN NO EVENT WILL Campus Swap BE LIABLE FOR (I) ANY INCIDENTAL,
...
INFORMATION OR SERVICE.  EVEN IF Campus Swap OR ITS
...
STATES, Campus Swap LIABILITY IS LIMITED TO THE GREATEST
EXTENT PERMITTED BY LAW.
<p>

Campus Swap makes no representations whatsoever about any other
web site which you may access through this one or which may link to
this Site. When you access a non-Campus Swap web site, please
understand that it is independent from Campus Swap, and that
Campus Swap has no control over the content on that web site. In
addition, a link to a Campus Swap web site does not mean that
Campus Swap endorses or accepts any responsibility for the content,
...
<blockquote>
You agree to indemnify, defend and hold harmless Campus Swap, its
...
(Indemnification) are for the benefit of Campus Swap and its
officers, directors, employees, agents, licensors, suppliers, and any
...
action or proceeding between Campus Swap and you for any purpose
...
cause of action is barred. Campus Swap's failure to insist upon or
...
modify any provision of this Agreement.  Campus Swap may assign
